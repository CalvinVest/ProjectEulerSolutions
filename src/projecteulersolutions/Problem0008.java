...
public class Problem0008 implements Problem {
    private String str = "73167176531330624919225119674426574742355349194934"
    ...
    private long findLargestSubstringProduct() {
        long maxSubstrProd = 0;
        for(String substr : getAdjacentDigitArrays()) {
    ...
    private String[] getAdjacentDigitArrays() {
